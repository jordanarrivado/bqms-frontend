...
const socket = io.connect("https://bqms-backend.onrender.com", {
    ...
    const fetchPlayers = async () => {
      try {
        ...
        const response = await axios.get(
          `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localArea)}/sessions/${encodeURIComponent(sessionDate)}/players`
        );
...
useEffect(() => {
  ...
  const addPlayer = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localArea)}/sessions/${encodeURIComponent(sessionDate)}/addPlayer`,
  ...
  const handleEditPlayer = async (id) => {
    ...
    if (updatedName) {
      try {
        await axios.put(
          `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localStorage.getItem('LocalArea'))}/sessions/${encodeURIComponent(localStorage.getItem('Session'))}/players/${id}`,
          { name: updatedName.trim() }
        );
        await axios.put(
          `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localStorage.getItem('LocalArea'))}/sessions/${encodeURIComponent(localStorage.getItem('Session'))}/players/history/${id}`,
          { name: updatedName.trim() }
        );
  ...
  const handleDeletePlayer = async (id) => {
    try {
      await axios.delete(`https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localStorage.getItem('LocalArea'))}/sessions/${encodeURIComponent(localStorage.getItem('Session'))}/players/${id}`);

      await axios.delete(`https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localStorage.getItem('LocalArea'))}/sessions/${encodeURIComponent(localStorage.getItem('Session'))}/players/history/${id}`);
  ...
  const addTenPlayers = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localArea)}/sessions/${encodeURIComponent(sessionDate)}/bulkAddPlayers`,
