    ...
    const fetchMatches = async () => {
      try {
        ...
        const response = await axios.get(
          `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localArea)}/sessions/${encodeURIComponent(sessionDate)}/inMatch`
        );
 ...
 */
  ...
  const handleDeleteMatch = () => {
    ...
    axios
      .delete(`https://bqms-backend.onrender.com/users/${user.email}/areas/${localArea}/sessions/${sessionDate}/inMatch`)
      .then(() => {
        setInMatch([]);
        return axios.delete(`https://bqms-backend.onrender.com/users/${user.email}/areas/${localArea}/sessions/${sessionDate}/matches`);
      })
      .then(() => {
        setMatches([]);
        setMatchLoading(false);
