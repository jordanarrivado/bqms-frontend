  ...
  const handleGotoSession = async (area, session) => {
    ...
    try {
      const sessionResponse = await axios.get(
        `https://bqms-backend.onrender.com/users/${user.email}/areas/${area.name}/sessions`
      );
  ...
  const handleDisplayPlayers = async (area, session) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://bqms-backend.onrender.com/users/${user.email}/areas/${area.name}/sessions/${encodedDate}/playerHistory`
      );
