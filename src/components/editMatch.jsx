...
const EditMatch = ({ user, match, players, onSave, onCancel, inMatch, setPlayerLoading, setMatchLoading, setEditingMatch }) => {
  ...
  const handleSubmit = async () => {
    ...
    const url = `https://bqms-backend.onrender.com/users/${user.email}/areas/${encodeURIComponent(localArea)}/sessions/${encodeURIComponent(sessionDate)}/inMatch/${match._id}`;
