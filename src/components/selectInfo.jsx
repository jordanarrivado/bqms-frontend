...
const SelectInfo = ({ 
  ...
  useEffect(() => {
    const fetchCourtType = async () => {
      try{
        const response = await axios.get(`https://bqms-backend.onrender.com/users/${user.email}/areas/${selectedArea.name}/courtFeeType`);
  ...
  useEffect(() => {
    const fetchSessions = async () => {
      try {
        const response = await axios.get(`https://bqms-backend.onrender.com/users/${user.email}/areas/${selectedArea.name}/sessions`);
  ...
  const handleSession = async (component, mode) => {
    ...
    if (displayData) {
      try {
        ...
        await axios.put(
          `https://bqms-backend.onrender.com/users/${user.email}/areas/${selectedArea.name}/session`, 
